defmodule EasyBillsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EasyBillsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EasyBillsWeb.Gettext, "errors", msg, opts)
    end
  end
